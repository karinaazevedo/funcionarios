...
<html>
	...
	<body>
		<a href="#create-cargo" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-cargo" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:cargoInstance, action:'save']" >
				<fieldset class="form">

...
<div class="fieldcontain ${hasErrors(bean: dependenteInstance, field: 'identidade', 'error')} required">
	<label for="identidade">
		<g:message code="dependente.identidade.label" default="Identidade" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="identidade" required="" value="${dependenteInstance?.identidade}"/>

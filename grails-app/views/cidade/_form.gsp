...
<div class="fieldcontain ${hasErrors(bean: cidadeInstance, field: 'estado', 'error')} required">
	...
	<g:select id="estado" name="estado.id" from="${funcionarios.Estado.list()}" optionKey="id" required="" value="${cidadeInstance?.estado?.id}" optionValue="sigla" class="many-to-one"/>

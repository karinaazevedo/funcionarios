...
<%@ page import="funcionarios.Cidade" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-cidade" class="content scaffold-show" role="main">
			...
			<ol class="property-list cidade">
				...
				<g:if test="${cidadeInstance?.enderecos}">
				<li class="fieldcontain">
					<span id="enderecos-label" class="property-label"><g:message code="cidade.enderecos.label" default="Enderecos" /></span>
					
						<g:each in="${cidadeInstance.enderecos}" var="e">
				...
				<li class="fieldcontain">
					<span id="estado-label" class="property-label"><g:message code="cidade.estado.label" default="Estado" /></span>
						...
						<span class="property-value" aria-labelledby="estado-label"><g:link controller="estado" action="show" id="${cidadeInstance?.estado?.id}">${cidadeInstance?.estado?.sigla}</g:link></span>
